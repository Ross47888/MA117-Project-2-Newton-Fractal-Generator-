...
class Newton {
    ...
    public void iterate(Complex z0) {
        ...
        numIterations = 0;
        Complex z1;
        while(toBreak == false && numIterations < MAXITER){
          ...
          if(Math.abs(z0.abs() - z1.abs()) < this.TOL){
            toBreak = true;
            this.err = 0;
            this.root = z0;
          }
    ...
    public static void main(String[] args) {
        ...
        // z_0 = 1+i.
        Complex[] coeff = new Complex[] { new Complex(), new Complex(0,1),
                                          new Complex(), new Complex(1.0,0.0) };
        Polynomial p = new Polynomial(coeff);
        Newton n  = new Newton(p);

        n.iterate(new Complex(0.1));
        Complex h = n.root;
