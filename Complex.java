...
public class Complex {
    ...
    public Complex add(Complex b) {
        // You need to fill in this method.
        double rl = this.x + b.getReal();
        double im = this.y + b.getImag();
    ...
    public Complex multiply(double alpha) {
        // You need to fill in this method.
        double a = alpha * this.x;
        double b = alpha * this.y;
    ...
    public Complex divide(Complex b) {
        ...
        double c = b.getReal();
        double d = b.getImag();
        double a = (this.x * c) + (this.y * d);
        double s =(this.y * c) - (this.x * d);
        Complex h = new Complex(a,s);
        h = h.multiply((1/(c*c + d*d)));
        return h;
    }
